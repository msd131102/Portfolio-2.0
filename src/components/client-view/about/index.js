        ...
        <AnimationWrapper className={"flex items-center w-full p-4"}>
          ...
          >
            {data?.skills.split(",").map((skill) => (
              ...
              >
                <button className="whitespace-nowrap text-ellipsis overflow-hidden py-3 w-[160px] px-0 border border-gray-300 rounded-lg shadow-sm
 border-green-main bg-[#fff] text-[#000] font-semibold rounded-lg text-xl tracking-widest hover:shadow-green-main transition-all outline-none">
                  {skill}
                </button>
              </motion.div>
            ))}
