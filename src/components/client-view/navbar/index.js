        ...
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          <div className="col-start-1 col-end-2 flex items-center">
            <div className="cursor-pointer flex gap-2 font-bold items-center text-[20px] text-blue-main">
              <div className="w-[40px] h-[40px] flex justify-center items-center p-3 rounded-[8px] border-green-main bg-green-main">
                <span className="text-[#0e0303] text-[25px] font-bold">P</span>
              </div>
              ortfolio
            </div>
          </div>
          ...
          <div className="col-start-10 col-end-12 font-medium flex justify-center items-center">
            <button
              ...
              className="py-3 px-6 border-[2px] bg-[#fff] border-blue-main text-[#000] font-semibold rounded-lg text-xl tracking-widest hover:shadow-green-md transition-all outline-none"
            >
              Contact Me
            </button>
          </div>
